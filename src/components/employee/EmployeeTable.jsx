...
import { updateEmployee, deleteEmployee } from '../../api/employee.api';
import {
   addAssetToEmployee,
                        ...
                        <tbody>
                           {selectedEmployee?.assets?.map(asset => (
                              <tr key={asset.id}>
                                 ...
                                 <th className="text-left">
                                    {moment(asset.assignmentDate).format(
                                       'DD/MM/YYYY'
                                    )}
                                 </th>
                                 <th className="text-left">
                                    {moment(asset.deliveryDate).format(
                                       'DD/MM/YYYY'
                                    )}
                                 </th>
                                 {!asset.releaseDate ? (
                                    ...
                                    <th className="text-left">
                                       {moment(asset.releaseDate).format(
                                          'DD/MM/YYYY'
                                       )}
                                    </th>
                                 )}
